...
function App() {
  ...
  return (
    <div className='FontChange'>
      ...
      <ul className=" col-12 col-md-auto justify-content-center mb-md-0">
        <nav>
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
        ...
        <Link to="/stadium" className="nav-link px-2">Stadium List</Link> &nbsp;
        <Link to="/sport" className="nav-link px-2">Sport List</Link> &nbsp;
        <Link to="/facility" className="nav-link px-2">Facility List</Link> &nbsp;
        ...
        <Link to='/mystadium'className="nav-link px-2">My Stadiums</Link>
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
        ...
        {/* <Link to="/facility" className="nav-link px-2">Facility List</Link> &nbsp; */}
        {/* <Link to="/reservations" className="nav-link px-2">Reservations</Link> &nbsp; */}
        {/* <Link to='/mystadium'className="nav-link px-2">My Stadium </Link> */}
        <div className="dropdown text-end">
          <a href="#" className="d-block link-body-emphasis text-decoration-none dropdown-toggle show" data-bs-toggle="dropdown" aria-expanded="true">
            {userDetails &&<img src={"/images/"+userDetails.image} alt="mdo" width="32" height="32" className="rounded-circle"/>}
          </a>
